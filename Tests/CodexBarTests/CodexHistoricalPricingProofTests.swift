...
struct CodexHistoricalPricingProofTests {
    ...
    func `writes redacted real scan proof for GPT56 historical pricing`() async throws {
        ...
        cutoffUTC: 2026-07-30T00:00:00Z
        fixture: local synthetic codex JSONL sessions scanned through the real scanner path
        2026-07-29 gpt-5.6-terra costUSD=\(terraBefore.costUSD ?? -1) totalTokens=\(terraBefore.totalTokens ?? -1)
        2026-07-30 gpt-5.6-terra costUSD=\(terraAfter.costUSD ?? -1) totalTokens=\(terraAfter.totalTokens ?? -1)
        2026-07-29 gpt-5.6-luna costUSD=\(lunaBefore.costUSD ?? -1) totalTokens=\(lunaBefore.totalTokens ?? -1)
        2026-07-30 gpt-5.6-luna costUSD=\(lunaAfter.costUSD ?? -1) totalTokens=\(lunaAfter.totalTokens ?? -1)
        """
        try log.write(
